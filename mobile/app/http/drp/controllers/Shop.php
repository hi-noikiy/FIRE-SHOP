...
class Shop extends \app\http\base\controllers\Frontend
{
	private $region_id;
	private $area_id;
	private $isself = 0;
	...
	public function actionIndex()
	{
		...
		if (IS_AJAX) {
			$goodslist = get_goods($where, $this->region_id, $this->area_id, $size, $page, $status, $type, $this->cat_id);
		...
		$this->assign('description', '快来参观我的店铺吧，惊喜多多优惠多多');
		$this->assign('page_img', $shop_info['headimgurl']);
		$this->display();
	}
