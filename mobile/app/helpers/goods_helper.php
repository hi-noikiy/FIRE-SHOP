...
{
	$sql = 'SELECT img_id, img_url, thumb_url, img_desc' . ' FROM ' . $GLOBALS['ecs']->table('goods_gallery') . ' WHERE goods_id = \'' . $goods_id . '\'  ORDER BY img_desc ASC LIMIT ' . $GLOBALS['_CFG']['goods_gallery_number'];
