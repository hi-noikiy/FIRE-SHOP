...
function is_mobile($mobile)
{
	...
	return preg_match('/^1(3[0-9]|4[57]|5[0-35-9]|7[0135678]|8[0-9])\\d{8}$/', $mobile) ? true : false;
}
...
{
	$sql = 'SELECT u.user_id, u.email, u.user_name, u.user_money, u.mobile_phone, u.pay_points' . ' FROM ' . $GLOBALS['ecs']->table('users') . ' AS u ' . ' WHERE u.user_id = \'' . $user_id . '\'';
