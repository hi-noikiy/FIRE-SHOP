	...
	public function callback($callback_url, $code)
	{
		if (!empty($code)) {
			...
			if (isset($result['access_token']) && ($result['access_token'] != '')) {
				...
				$data = array('openid' => $openid, 'nickname' => $this->get_user_name($userinfo), 'sex' => $userinfo['gender'], 'headimgurl' => $userinfo['figureurl_qq_2'] ? $userinfo['figureurl_qq_2'] : $userinfo['figureurl_qq_1']);
