...
if (!$smarty->is_cached('brand_list.dwt', $cache_id)) {
	...
	$goodslist = brand_get_goods($brand_id, $mbid, $cate, $size, $page, $sort, $order, $region_id, $area_info['region_id'], $act, $ship, $price_min, $price_max, $self);
