...
{
	global $_LANG;
	$_SESSION['seller_action_list'] = isset($_SESSION['seller_action_list']) ? $_SESSION['seller_action_list'] : $_SESSION['seller_action_list'];

	if ($_SESSION['seller_action_list'] == 'all') {
		return true;
	}

	if (strpos(',' . $_SESSION['seller_action_list'] . ',', ',' . $priv_str . ',') === false) {
