...
$modules['19_merchants_store']['11_touch_dashboard'] = '../mobile/index.php?m=admin&c=editorseller';
...
if (is_dir(MOBILE_TEAM)) {
	$modules['03_promotion']['18_team'] = 'team.php?act=list';
}
...
if (file_exists(MOBILE_WECHAT)) {
	...
	$modules['22_wechat']['09_extend'] = '../mobile/index.php?m=wechat&c=sellerextend&a=index';
}
