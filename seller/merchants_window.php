...
if ($_REQUEST['act'] == 'list') {
	...
	$smarty->assign('action_link', array('text' => '添加店铺橱窗', 'href' => 'merchants_window.php?act=add', 'class' => 'icon-plus'));
	...
	$smarty->assign('action_link', array('text' => '店铺橱窗列表', 'href' => 'merchants_window.php?act=list', 'class' => 'icon-reply'));
