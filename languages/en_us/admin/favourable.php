...
$_LANG['notice_act_type'] = 'When the concession for the "enjoyment of gifts (for ex-gratia goods)", please enter the permit buyers to choose gift (ex-gratia goods) the maximum quantity, quantity to 0 express an unlimited number;' . 'When the concession for the \\"enjoyment of cash for relief\\", enter the amount of cash relief;' . 'When the concession for the \\"enjoyment of price discounts\\", please enter the discount (1-99), such as: playing 9 packs, on the input 90.';
