...
$_LANG['remark_info'] = '<ul>' . '<Li>For the promotion product, you need to edit its original price(this shop selling price) and sales promotion date;</li>' . '<Li>Please re-create watermark;</li>' . '<Li>Please re-create an advertisement;</li>' . '<Li>Please re-create shipping method;</li>' . '<Li>Please re-create payment method;</li>' . '<li>Please move the former product of not bottom category to bottom category:</li>' . '</ul>';
