...
$_LANG['server_errors'][1] = '注册信息无效。';
$_LANG['server_errors'][2] = '启用信息无效。';
$_LANG['server_errors'][3] = '发送的信息有误。';
$_LANG['server_errors'][4] = '填写的查询信息有误。';
$_LANG['server_errors'][5] = '无效的身份信息。';
$_LANG['server_errors'][6] = 'URL不对。';
$_LANG['server_errors'][7] = 'HTTP响应体为空。';
$_LANG['server_errors'][8] = '无效的XML文件。';
$_LANG['server_errors'][9] = '无效的节点名字。';
$_LANG['server_errors'][10] = '存储失败。';
$_LANG['server_errors'][11] = '短信功能尚未激活。';
