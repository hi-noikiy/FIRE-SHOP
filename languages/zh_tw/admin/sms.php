...
$_LANG['server_errors'][1] = '註冊信息無效。';
$_LANG['server_errors'][2] = '啟用信息無效。';
$_LANG['server_errors'][3] = '發送的信息有誤。';
$_LANG['server_errors'][4] = '填寫的查詢信息有誤。';
$_LANG['server_errors'][5] = '無效的身份信息。';
$_LANG['server_errors'][6] = 'URL不對。';
$_LANG['server_errors'][7] = 'HTTP響應體為空。';
$_LANG['server_errors'][8] = '無效的XML文件。';
$_LANG['server_errors'][9] = '無效的節點名字。';
$_LANG['server_errors'][10] = '存儲失敗。';
