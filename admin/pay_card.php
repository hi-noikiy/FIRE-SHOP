...
if ($_REQUEST['act'] == 'pc_list') {
	...
	$smarty->assign('action_link', array('href' => 'pay_card.php?act=list', 'text' => $_LANG['05_shoppingcard']));
	$list = get_bonus_list();
	$bonus_type = bonus_type_info(intval($_REQUEST['tid']));
