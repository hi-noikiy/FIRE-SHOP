...
if ($_REQUEST['act'] == 'list_edit') {
	...
	$update_arr = array('mobile' => $_POST['value'][801], 'seller_email' => $_POST['value'][114], 'kf_qq' => $_POST['value'][109], 'kf_ww' => $_POST['value'][110], 'shop_title' => $_POST['value'][102], 'shop_keyword' => $_POST['value'][104], 'country' => $_POST['value'][105], 'province' => $_POST['value'][106], 'city' => $_POST['value'][107], 'district' => 0, 'shop_address' => $_POST['value'][108], 'kf_tel' => $_POST['value'][115], 'notice' => $_POST['value'][121]);
	...
	foreach ($_FILES as $code => $file) {
		if ((isset($file['error']) && ($file['error'] == 0)) || (!isset($file['error']) && ($file['tmp_name'] != 'none'))) {
			if (!check_file_type($file['tmp_name'], $file['name'], $allow_file_types)) {
				...
				$code_store_dir = array('ecjia_qrcode', 'ectouch_qrcode', 'index_down_logo', 'site_commitment', 'user_login_logo', 'login_logo_pic');
