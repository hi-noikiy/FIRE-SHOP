...
if ($_REQUEST['act'] == 'list') {
	...
	get_oss_add_file(array(DATA_DIR . '/afficheimg/' . $ad_code, DATA_DIR . '/afficheimg/' . $ad_bg_code));
	...
	get_oss_add_file(array(DATA_DIR . '/afficheimg/' . $ad_images, DATA_DIR . '/afficheimg/' . $ad_bg_images));
