...
if ($_REQUEST['act'] == 'list') {
	...
	if ($_GET['flag'] == 'download') {
		...
		$ave_user_turnover = (0 < $user_num ? price_format($user_all_order['turnover'] / $user_num) : 0);
		...
		$order_num = (0 < $guest_all_order['order_num'] ? price_format($guest_all_order['turnover'] / $guest_all_order['order_num']) : 0);
	...
	$smarty->assign('ave_user_turnover', 0 < $user_num ? price_format($user_all_order['turnover'] / $user_num) : 0);
