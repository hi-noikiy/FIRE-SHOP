...
if ($_REQUEST['act'] == 'list') {
	...
	if (($_REQUEST['act'] == 'add') || ($_REQUEST['act'] == 'edit')) {
		...
		if (($_REQUEST['act'] == 'insert') || ($_REQUEST['act'] == 'update')) {
			...
			$sql = 'UPDATE' . $ecs->table('offline_store') . ' SET stores_name=\'' . $stores_name . '\',country=\'' . $country . '\'' . ',province=\'' . $province . '\',city=\'' . $city . '\',district=\'' . $district . '\',stores_address=\'' . $stores_address . '\',stores_tel=\'' . $stores_tel . '\',' . 'stores_opening_hours=\'' . $stores_opening_hours . '\',stores_traffic_line=\'' . $stores_traffic_line . '\',stores_img=\'' . $file_url . '\' WHERE id = \'' . $store_id . '\'';
