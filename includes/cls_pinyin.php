...
class pin
{
	public function Pinyin($_String, $_Code = 'gb2312')
	{
		...
		$_Data = ('5.0' <= PHP_VERSION ? array_combine($_TDataKey, $_TDataValue) : $this->Arr_Combine($_TDataKey, $_TDataValue));
		arsort($_Data);
		reset($_Data);
	...
	public function Pinyins($_Num, $_Data)
	{
		if ((0 < $_Num) && ($_Num < 160)) {
			return chr($_Num);
		}
