...
function sms_ali($params = array(), $send_time = '', $test = array())
{
	...
	if ($sms_type == 2) {
		$out_id = '1234';
		$result = array('OutId' => $out_id, 'SignName' => $SignName, 'TemplateCode' => $SmsCdoe, 'TemplateParam' => json_encode($smsParams), 'PhoneNumbers' => $params['mobile_phone']);
	}
	else {
