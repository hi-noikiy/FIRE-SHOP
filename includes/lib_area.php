...
$smarty->assign('selProvince_list', $selProvince_list);
$selCity_list = get_all_area_list($province_id, 2);
$smarty->assign('selCity_list', $selCity_list);
$selDistrict_list = get_all_area_list($city_id, 3);
$smarty->assign('selDistrict_list', $selDistrict_list);
$selectLocate = 0;
...
$sql = 'select kf_qq, kf_ww, kf_type, kf_tel from ' . $ecs->table('seller_shopinfo') . ' where ru_id = 0 LIMIT 1';
