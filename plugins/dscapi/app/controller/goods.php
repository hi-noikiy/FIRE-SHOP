...
class goods extends \app\model\goodsModel
{
	...
	{
		$this->goods($where);
		$this->wehre_val = array('seller_id' => $this->seller_id, 'brand_id' => $this->brand_id, 'cat_id' => $this->cat_id, 'user_cat' => $this->user_cat, 'goods_id' => $this->goods_id, 'goods_sn' => $this->goods_sn, 'bar_code' => $this->bar_code, 'warehouse_id' => $this->warehouse_id, 'area_id' => $this->area_id, 'region_sn' => $this->region_sn, 'img_id' => $this->img_id, 'attr_id' => $this->attr_id, 'goods_attr_id' => $this->goods_attr_id, 'tid' => $this->tid, 'seller_type' => $this->seller_type);
