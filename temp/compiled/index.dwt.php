...
?>
    ...
    <div class="lift lift-hide" ectype="lift" style="z-index:100001">
    	<div class="lift-list" ectype="liftList">
            ...
            <div class="lift-item lift-h-need lift-item-current" ectype="liftItem" data-target="#h-need"><span>推荐</span></div>
            <div class="lift-item" ectype="liftItem" data-target="#h-brand"><span>品牌</span></div>
			<?php $_from = $this->_var['floor_data']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'data_0_11885400_1504930449');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['data_0_11885400_1504930449']):
?>
            <div class="lift-item lift-floor-item" ectype="liftItem"><span><?php echo $this->_var['data_0_11885400_1504930449']['name']; ?></span></div>
			<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
            <div class="lift-item lift-master" ectype="liftItem" data-target="#master"><span>达人</span></div>
            <div class="lift-item lift-storeRec" ectype="liftItem" data-target="#storeRec"><span>店铺</span></div>
            <div class="lift-item" ectype="liftItem" data-target="#guessYouLike"><span>商品</span></div>
            <div class="lift-item lift-item-top" ectype="liftItem"><i class="iconfont icon-returntop"></i></div>
        </div>
    </div>
    ...
    <div class="ejectAdv" ectype="ejectAdv">
    	...
    	<div class="ejectAdvimg">
        	<a href="#" target="_blank"><img src="themes/<?php echo $GLOBALS['_CFG']['template']; ?>/images/ejectadv.png"></a>
