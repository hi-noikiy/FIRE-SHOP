...
<?php if ($this->_var['temp'] == 'navigator_home'): ?>
    <li><a href="<?php echo $this->_var['index_url']; ?>" class="curr">首页</a></li>
...
<li <?php if ($this->_var['default_tem'] == $this->_var['template']['code']): ?>class="curr"<?php endif; ?>>
    ...
    <div class="info">
        <p><a href="<?php echo $this->_var['template']['template']; ?>" class="nyroModal" target="_blank" ectype="see">查看大图</a><a href="visualhome.php?act=visual&code=<?php echo $this->_var['template']['code']; ?>" class="zx" target="_blank">装修</a></p>
        <p class="mt5">
            <a href="../index.php?suffix=<?php echo $this->_var['template']['code']; ?>" class="ml10" target="_blank" >预览模板</a>
