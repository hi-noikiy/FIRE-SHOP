                            ...
                            <div class="sort_tit">
                                ...
                                <div class="select_list select_w320" id="sortcommList">
                                    ...
                                    <ul>
                                        ...
                                        <?php $_from = $this->_var['recently_used_category']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'category_0_60937500_1503823105');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['category_0_60937500_1503823105']):
?>
                                        <li><a href="javascript:void(0);" data-value="<?php echo $this->_var['key']; ?>"><?php echo $this->_var['category_0_60937500_1503823105']; ?></a></li>
...
?>
                                    ...
                                    <?php endif; ?>
                                    <div class="item">
                                        <div class="step_label"><em class="require-field">*</em>本店售价：</div>
                                                ...
                                                <div class="brand-top">
                                                    <div class="letter">
                                                        <ul>
                                                            ...
                                                            <?php $_from = $this->_var['letter']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'letter_0_60937500_1503823105');if (count($_from)):
    foreach ($_from AS $this->_var['letter_0_60937500_1503823105']):
?>
                                                            <li><a href="javascript:void(0);" data-letter="<?php echo $this->_var['letter_0_60937500_1503823105']; ?>"><?php echo $this->_var['letter_0_60937500_1503823105']; ?></a></li>
                                                            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
...
?>
                                    ...
                                    <div class="item">
                                        <div class="step_label"><?php echo $this->_var['lang']['lab_commission_rate']; ?>：</div>
                                        	<div class="step_value"><input type="text" name="commission_rate" class="text w150" autocomplete="off" value="<?php echo $this->_var['goods']['commission_rate']; ?>"/>
...
?>
   ...
   /* function append_mobile_img(obj){
	...
	function append_mobile_text(obj){
		...
		text = text.replace('"',"“");
		text = text.replace('&',"&amp;");
		pannel_div = "<div class='section s-txt'><div class='txt'>"+text+"</div><div class='tools'><a href='javascript:void(0);' class='move-up icon-arrow-up'></a><a href='javascript:void(0);' class='move-down icon-arrow-down'></a><a href='javascript:void(0);' class='move-remove'><i class='icon icon-remove'></i>删除</a><div class='cover'></div></div></div>";
		$(".section_warp").append(pannel_div);
		$(".section_warp").find(".section:first").find(".move-up").addClass("disabled");
		$(".section_warp").find(".section:last").find(".move-down").addClass("disabled");
	...
	/*$("[ectype='gallery_album']").on("click",function(){
		...
		var img_src = "";
		var obj = "";
		Ajax.call('dialog.php', "act=shop_banner&is_vis=2&image_type=1&inid=" + inid, function(result){
			goods_visual_desc("图片编辑器",915,result.content,function(){
