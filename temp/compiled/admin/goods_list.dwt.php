...
<script type="text/javascript" src="../includes/taobao/jsapi.js"></script>
<link rel="stylesheet" type="text/css" href="../includes/taobao/extend.css" />
</head>
        	...
        	<div class="tabs_info">
            	<ul>
                    <li <?php if ($this->_var['menu_select']['current'] == '01_goods_list'): ?>class="curr"<?php endif; ?>>
                    	<a href="goods.php?act=list">普通商品 <?php if ($this->_var['menu_select']['current'] != '01_goods_list'): ?><?php if ($this->_var['goods_list_type']): ?><em class="li_color">(<?php echo empty($this->_var['goods_list_type']['ordinary']) ? '0' : $this->_var['goods_list_type']['ordinary']; ?>)</em><?php endif; ?><?php endif; ?></a>
                    </li>
                    <li <?php if ($this->_var['menu_select']['current'] == '50_virtual_card_list'): ?>class="curr"<?php endif; ?>>
                    	<a href="goods.php?act=list&extension_code=virtual_card">虚拟商品 <?php if ($this->_var['menu_select']['current'] != '50_virtual_card_list'): ?><?php if ($this->_var['goods_list_type']): ?><em class="li_color">(<?php echo empty($this->_var['goods_list_type']['virtual_card']) ? '0' : $this->_var['goods_list_type']['virtual_card']; ?>)</em><?php endif; ?><?php endif; ?></a>
                    </li>
                    <?php if ($this->_var['cfg']['review_goods']): ?>
                	<li <?php if ($this->_var['menu_select']['current'] == '01_review_status'): ?>class="curr"<?php endif; ?>>
                    	<a href="goods.php?act=review_status">商品审核 <?php if ($this->_var['menu_select']['current'] != '01_review_status'): ?><?php if ($this->_var['goods_list_type']): ?><em class="li_color">(<?php echo empty($this->_var['goods_list_type']['review_status']) ? '0' : $this->_var['goods_list_type']['review_status']; ?>)</em><?php endif; ?><?php endif; ?></a>
                    </li>
                    <?php endif; ?>
					<li <?php if ($this->_var['menu_select']['current'] == '11_goods_trash'): ?>class="curr"<?php endif; ?>>
                    	<a href="goods.php?act=trash">商品回收站 <?php if ($this->_var['menu_select']['current'] != '11_goods_trash'): ?><?php if ($this->_var['goods_list_type']): ?><em class="li_color">(<?php echo empty($this->_var['goods_list_type']['delete']) ? '0' : $this->_var['goods_list_type']['delete']; ?>)</em><?php endif; ?><?php endif; ?></a>
                    </li>
                    <li <?php if ($this->_var['menu_select']['current'] == '19_is_sale'): ?>class="curr"<?php endif; ?>>
                    	<a href="goods.php?act=is_sale">上架商品 <?php if ($this->_var['menu_select']['current'] != '19_is_sale'): ?><?php if ($this->_var['goods_list_type']): ?><em class="li_color">(<?php echo empty($this->_var['goods_list_type']['is_sale']) ? '0' : $this->_var['goods_list_type']['is_sale']; ?>)</em><?php endif; ?><?php endif; ?></a>
                    </li>
                    
                    <li <?php if ($this->_var['menu_select']['current'] == '20_is_sale'): ?>class="curr"<?php endif; ?>>
                    	<a href="goods.php?act=on_sale">下架商品 <?php if ($this->_var['menu_select']['current'] != '20_is_sale'): ?><?php if ($this->_var['goods_list_type']): ?><em class="li_color">(<?php echo empty($this->_var['goods_list_type']['on_sale']) ? '0' : $this->_var['goods_list_type']['on_sale']; ?>)</em><?php endif; ?><?php endif; ?></a>
                    </li>
                </ul>
            </div>			
            ...
            <div class="flexilist">
                ...
                <div class="common-head">
                    <div class="fl">
                        ...
                        <a href="goods_transport.php?act=list"><div class="fbutton"><div class="edit" title="商品运费模板"><span><i class="icon icon-edit"></i>商品运费模板</span></div></div></a>
                                                ...
                                                <div class="value">
                                                    ...
                                                    <?php elseif ($this->_var['goods']['freight'] == 2): ?>
                                                    	<?php if ($this->_var['goods']['transport']['freight_type'] == 1): ?>
                                                        	<?php echo $this->_var['lang']['lab_freight_type']['two']; ?><em class="red">(<?php echo $this->_var['lang']['lab_goods_freighttemp']; ?>)</em>
                                                        <?php else: ?>
                                                            <?php echo $this->_var['lang']['lab_freight_temp']; ?>
                                                            <?php if ($this->_var['goods']['transport']['type'] == 1): ?>
                                                            	(<?php echo $this->_var['lang']['lab_freight_super']; ?>)
                                                            <?php else: ?>
                                                            	(<?php echo $this->_var['lang']['lab_freight_unify']; ?>)
                                                            <?php endif; ?>
                                                        <?php endif; ?>
                                                    <?php else: ?>
